...
$allowed = ["jpg", "JPG", "jpeg", "JPEG", "png", "PNG"];
$ext = pathinfo($_FILES["file"]["name"], PATHINFO_EXTENSION);
if (!in_array($ext, $allowed)):
    wp_send_json(["error" => __('The file your\'re trying to upload isn\'t a valid image type', 'polc')]);
endif;
...
$data = ["id" => $attachment_id, "src" => wp_get_attachment_image_src($attachment_id, "medium")[0]];
